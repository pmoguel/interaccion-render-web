...
3. En el evento “mousemove” donde estamos invocando la función para crear imágenes, vamos a definir la condición para crear la imagen:
    a. Primero calculamos la distancia en X y Y entre la posición de la última imagen y el mouse actualmente.
    b. Si la distancia calculada es mayor a nuestro espacio mínimo, solo entonces creamos la imagen.
...
window.addEventListener("mousemove", function (eventData){
    ...
    // calcular la distancia entre el mouse y la ultima imagen dibujada para evaluar nuestra condicion para renderizar o no.
